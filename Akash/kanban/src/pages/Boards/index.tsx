	...
	return (
		<>
			<DragDropContext onDragEnd={(result: any) => onDragEnd(result, columns, setColumns)}>
				<div className=" flex items-start justify-between px-5 pb-8 md:gap-0 gap-10 ">
						...
						>
							...
							>
								{(provided: any) => (
									...
									>
										<div className="flex items-center justify-center py-[10px] w-full bg-white rounded-lg shadow-sm text-[#555] font-medium text-[15px] bg-gray-900">
											{column.name}
										</div>
